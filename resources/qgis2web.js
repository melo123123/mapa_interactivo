...
map.getView().fit([-8614057.252974, -1373526.123277, -8528673.736953, -1321768.796171], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Conexiones con georreferenciación verificada en campo 17/12/2024</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_RedGrandesClientesAct16122024_1,
    colName: 'ccss',
    zoom: 10,
    collapsed: true,
    map: map
